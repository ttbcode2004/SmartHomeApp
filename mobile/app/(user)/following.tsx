...
export default function FollowingScreen() {
  ...
  const { dbUser, getFollowing } = useCurrentUser();
  ...
  useEffect(() => {
    ...
    getFollowing(dbUser._id)
      .then((data) => {
        setFollowing(data as unknown as UserCardUser[]);
      })
    ...
    >
      ...
      <View className="px-4 py-3">
        ...
        >
          ...
          <TextInput
            ...
            placeholder="Tìm người đang theo dõi..."
      ...
      {isLoading ? (
        ...
        <View className="flex-1 items-center justify-center gap-3">
          <Feather name="user-check" size={52} color={colors.border} />
